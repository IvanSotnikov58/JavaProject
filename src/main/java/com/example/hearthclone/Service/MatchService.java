...
public class MatchService {
    ...
    private void dealCards(Match match, User player) {
        ...
        // poka prosto vivodim v konsol ili sohranit v otdelnoe pole match, map player->cards
    ...
    public void playTurn(Match match, User player, Cards card, String target, String result, int turnNumber) {
        ...
        // proverka okonchanija igri
        if (turnNumber >= 10) { // match zakanchivaetsja v 10 raundah
