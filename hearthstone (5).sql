...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2025 at 11:29 AM
...
(32, 'Коробка пандоры', 0, 0, 'SPELL', 'Коробка пандоры всё время наносит разное количество урона миьнону при открытии, от одного до десяти', 'random_damage', '10', 5),
